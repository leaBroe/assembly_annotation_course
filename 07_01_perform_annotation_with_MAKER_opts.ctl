...
genome=/data/users/lbroennimann/assembly_annotation_course/MAKER/polished_genome/polished.fasta #genome sequence (fasta file or fasta embeded in GFF3 file)
...
est=/data/users/lbroennimann/assembly_annotation_course/assembly/RNAseq_assemblies/SRR1584462_2_trinity_assembly/Trinity.fasta #set of ESTs or assembled mRNA-seq in fasta format
...
rmlib=/data/users/lbroennimann/assembly_annotation_course/polished.fasta.mod.EDTA.anno/polished.fasta.mod.EDTA.TElib.fa #provide an organism specific repeat library in fasta format for RepeatMasker
