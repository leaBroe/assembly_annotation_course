...
polish_evaluation_dir=${course_dir}/assembly_validation/pilon  # Change to the polish_evaluation_dir path from the first script
pilon_dir=${polish_evaluation_dir}/polish/pilon  # Change to the pilon_dir path from the first script
...
assembly=${course_dir}/assembly/canu/pacbio_assemblies/ERR3415819_ERR3415820_canu/ERR3415819.contigs.fasta  # Change to the assembly path from the first script
